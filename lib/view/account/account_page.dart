...
class _AccountPageState extends State<AccountPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        /**
         * SingleChildScrollviewで画面全体をスクロールできるようにする
         * その下の階層がColumnだと高さを表示できないウィジェットだから
         * 間にContainerを入れてMediaQueryで画面いっぱいの高さを指定する
         * */
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(DateFormat('yyyy/M/dd').format(post.createdTime!.toDate()))
                                                  ],
                                                ),
                                                Text(post.content)
                                              ],
